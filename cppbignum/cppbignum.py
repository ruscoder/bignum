...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_cppbignum', [dirname(__file__)])
        except ImportError:
            import _cppbignum
            return _cppbignum
        if fp is not None:
            try:
                _mod = imp.load_module('_cppbignum', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _cppbignum = swig_import_helper()
...
class Big(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Big, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Big, name)
    __repr__ = _swig_repr
    __swig_destroy__ = _cppbignum.delete_Big
